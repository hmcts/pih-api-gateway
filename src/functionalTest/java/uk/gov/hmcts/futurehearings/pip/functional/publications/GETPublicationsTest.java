...
public class GETPublicationsTest extends PublicationValidationTest {
    ...
    @Test
    void testGetPublicationsNotAuthorised() {
        Response response = commonDelegate.test_expected_response_for_supplied_header("invalidToken",
                                                                                      publicationsGetRootContext,
                                                                                      null,
                                                                                      createStandardPayloadHeader(),
                                                                                      null,
